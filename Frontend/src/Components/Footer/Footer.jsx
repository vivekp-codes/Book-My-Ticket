        ...
        <div className="grid md:grid-cols-[40%_20%_40%] gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><Link to="/user/bookings" className="hover:text-white">My Bookings</Link></li>
              <li><Link to="/user/wishlist" className="hover:text-white">Wishlist</Link></li>
              <li><Link to="/user/purchases" className="hover:text-white">Purchase History</Link></li>
              <li><Link to="/reset-password" className="hover:text-white">Change Password</Link></li>
            </ul>
          </div>
